...
- `index.html` renders the deck from those files: dark-first mission-control design (light theme via `prefers-color-scheme`), per-project live badges, and a live BTC ticker chip.
