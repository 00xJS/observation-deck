...
- [`projects.json`](projects.json) is the single source of truth — the page and the screenshot pipeline both read it. Adding a project is one JSON entry; optional fields (`featured`, `stack`, `caseStudy`) unlock the flagship slot, tech tags, and the case-study dialog.
